...
// t_cmd	*parse_simple_command(t_token **tokens, t_env *env);
t_cmd	*parse_simple_command(t_token **tokens, t_stock *stock);
// t_token	*handle_redirection(t_cmd **cmd, t_token *token);
// t_token *handle_redirection(t_cmd **cmd, t_token *token, t_token *head);
...
// int     dochere(int *fd, t_token *limiter, t_cmd *cmd, t_token *head);
int     dochere(int *fd, t_token *limiter, t_env *env);
// int     dochere(int *fd, t_token *limiter, t_cmd *cmd, t_token *head)
// int     heredoc(t_shell **shell);
// int     heredoc(t_cmd *cmd, t_token *tokenlim, t_token *head);
// int     heredoc(t_cmd *cmd, t_token *tokenlim, t_token *head, t_env *env);
